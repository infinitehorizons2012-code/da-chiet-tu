...
columns_to_keep = [
    ...
    'Link Âm Thanh Pinyin (Cloudinary MP3)',
    'Âm Hán Việt (Master 100%)',
    'Nghĩa Tiếng Việt (Master 100%)',
    'App_Comp_1', 'App_Comp_2', 'App_Comp_3', 'App_Comp_4', 'App_Comp_5', 'App_Comp_6',
    'App_Comp_7', 'App_Comp_8', 'App_Comp_9', 'App_Comp_10', 'App_Comp_11', 'App_Comp_12',
    'App_Mnemonic',
    'Tần Suất % Cộng Dồn (Jun Da)',
    'Group'
]
